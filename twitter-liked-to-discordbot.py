...
# 読み込むCogの名前を格納しておく。
INITIAL_EXTENSIONS = [
    'cogs.twitterliked2discordcog'
]

class TwitterLiked2DiscordBot(commands.Bot):
    # TwitterLiked2DiscordBotのコンストラクタ。
...
# twitter-liked-to-discordbotのインスタンス化、および、起動処理
